...
Cover the rectangle defined by `domain.corners` by a Voronoi tesselation based on points generated by 
kmeans clustering of the initial trajectory points in `traj`.
"""
